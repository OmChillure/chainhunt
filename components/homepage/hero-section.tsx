...
export default function HeroSection() {
    return (
        <section className='flex flex-col items-center justify-center leading-6' aria-label="Nextjs Starter Kit Hero">
            <div className='h-[72vh] flex flex-col items-center justify-center'>
            <h1 className={`${TITLE_TAILWIND_CLASS} text-[50px] scroll-m-20 font-semibold tracking-tight text-center max-w-[1120px] bg-gradient-to-b dark:text-white`}>
            <span className='bg-gradient-to-r from-[#c9184a] via-[#ff4d6d] to-[#ff758f] bg-clip-text text-transparent'>Chainhunt:</span> Solana product hunt
            </h1>
